...
ap.add_argument("-n", "--mean", required=True,
	help="path to Model mean (mean.binaryproto)")
...
# (1, 3, 224, 224)
blob = cv2.dnn.blobFromImage(image, 1, (227, 227), (104.006987932, 116.668767617, 122.678914341))
